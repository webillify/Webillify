...
Last reviewed: **2026-07-17 17:27:22 IST**

| ID             | Type           | Severity | Risk/issue                                                           | Evidence                                    | Mitigation/next action                                    | Owner                | Status                           |
| -------------- | -------------- | -------- | -------------------------------------------------------------------- | ------------------------------------------- | --------------------------------------------------------- | -------------------- | -------------------------------- |
| `WBL-RISK-001` | Risk           | CRITICAL | No backend/persistence exists                                        | README and source contain mock-only data    | Start BE-001 after FE-007 contracts                       | Backend              | OPEN                             |
...
| `WBL-RISK-009` | Resolved issue | HIGH     | No Git repository/CI evidence was available in the workspace         | Root Git `main`, GitHub origin and CI exist | Push baseline and monitor first workflow run              | Project owner/DevOps | RESOLVED 2026-07-17 17:27:22 IST |
